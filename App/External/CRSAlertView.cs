...
namespace Curse
{
        ...
        private void MakeUI()
        {
            ...
            if (Input != null)
            {
                ...
                _inputTextField = new UITextField
                {
                    ...
                    Placeholder = Input.Placeholder != null ? Input.Placeholder : string.Empty,
                    Text = Input.Text != null ? Input.Text : string.Empty,
                ...
                _inputLabel = new UILabel
                {
                    ...
                    Text = Input.Placeholder != null ? Input.Placeholder : string.Empty,
                    Alpha = 0,
                    Font = InputFont
                };
    ...
    public class CRSLoginAction
    {
        public string Text { get; set; }
        public bool Highlighted { get; set; }
        public UIColor TintColor { get; set; }
        public Action<CRSLoginView> DidSelect { get; set; }
    }
    public class CRSRegistrationAction
    {
        public string Text { get; set; }
        public bool Highlighted { get; set; }
        public UIColor TintColor { get; set; }
        public Action<CRSRegistrationView> DidSelect { get; set; }
    }
    #endregion
