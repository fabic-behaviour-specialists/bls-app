...
namespace Fabic.iOS
{
    public partial class AboutBehaviourScaleViewController : UIViewController, IDisposable, ICanCleanUpMyself
    {
        public AboutBehaviourScaleViewController(IntPtr handle) : base(handle)
        {
        ...
        public override void ViewWillAppear(bool animated)
        {
            ...
            tblMain.Source = new AboutBehaviourScaleViewControllerTableViewSource();
        }
