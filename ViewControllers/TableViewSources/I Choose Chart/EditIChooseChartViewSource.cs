...
{
    public class EditIChooseChartViewSource : UITableViewSource, IDisposable, ICanCleanUpMyself
    {
        ...
        public EditIChooseChartViewSource(List<IChooseChartItem> scaleItems, UIView superView)
        {
        ...
        {
            TableView = tableView;
            FabicTextEditOverlay overlay = new FabicTextEditOverlay(ScaleItems[indexPath.Row].ItemText, ScaleItems[indexPath.Row]);
            overlay.FabicColour = Data.Enums.FabicColour.Blue;
            overlay.FinishedEditingItem += Overlay_FinishedEditingItem;
            overlay.Show(SuperView);
        }

        void Overlay_FinishedEditingItem(object sender, EventArgs e)
        {
        ...
        public override UITableViewCell GetCell(UITableView tableView, NSIndexPath indexPath)
        {
            ...
            if (cell == null || indexPath.Row == 0)
            {
                ...
                text.Text = " •  " + ScaleItems[indexPath.Row].ItemText;
        ...
        public override nfloat GetHeightForRow(UITableView tableView, NSIndexPath indexPath)
        {
            ...
            if (ScaleItems.Count > indexPath.Row)
            {
                ...
                label.Text = ScaleItems[indexPath.Row].ItemText;
                label.Lines = 100;
        ...
        void Text_TouchesBegan(NSSet arg1, UIEvent arg2)
        {
        ...
        public override UITableViewRowAction[] EditActionsForRow(UITableView tableView, NSIndexPath indexPath)
        {
            UITableViewRowAction hiButton = UITableViewRowAction.Create(
                  ...
                  delegate
                  {
                      ...
                      FabicDatabaseController.SaveOrUpdateIChooseChartItem(ScaleItems[indexPath.Row]);
