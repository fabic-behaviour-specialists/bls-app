...
namespace Fabic.iOS
{
    public partial class AboutBodyLifeSkillsViewController : UIViewController
    {
        public AboutBodyLifeSkillsViewController(IntPtr handle) : base(handle)
        {
        ...
        public override void ViewWillAppear(bool animated)
        {
            ...
            tblMain.Source = new AboutBLSViewControllerTableViewSource();
            tblMain.Frame = this.View.Frame;
        }
