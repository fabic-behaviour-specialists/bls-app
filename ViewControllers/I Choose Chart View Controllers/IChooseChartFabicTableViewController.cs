...
namespace Fabic.iOS
{
    public partial class IChooseChartFabicTableViewController : UITableViewController, IIChooseChartViewController, IDisposable, ICanCleanUpMyself
    {
        ...
        public IChooseChartFabicTableViewController(IntPtr handle) : base(handle)
        {
        }
        ...
        public async override void ViewWillAppear(bool animated)
        {
            ...
            this.Title = "I Choose Chart Examples";
        }
        ...
        async Task RefreshAsync()
        {
            ...
            await Task.Run(() => { DataSource = FabicDatabaseController.FetchFabicIChooseChartsTemplates(true).Result; });
            IChooseChartFabicLibraryTableViewSource source = new IChooseChartFabicLibraryTableViewSource(DataSource);
