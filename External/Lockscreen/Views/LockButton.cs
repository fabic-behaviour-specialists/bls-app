...
namespace Xamarin.LockScreen.Views
{
    internal class LockButton : UIButton
    {
        ...
        {
            BorderColor = UIColor.White.FabicColour(Fabic.Data.Enums.FabicColour.Purple); ;
            SelectedColor = UIColor.LightGray;
            TextColor = UIColor.White.FabicColour(Fabic.Data.Enums.FabicColour.Purple); ;
            HighlightedTextColor = UIColor.White.FabicColour(Fabic.Data.Enums.FabicColour.Purple); ;
            string fontName = "HelveticaNeue-Thin";
            Version version = new Version(Constants.Version);

            if (version <= new Version(6, 1))
                fontName = "HelveticaNeue";

            NumberLabelFont = UIFont.FromName(fontName, 35);
            LetterLabelFont = UIFont.FromName("HelveticaNeue", 9);
        ...
        public void PerformLayout()
        {
            ...
            NumberLabel.Frame = new RectangleF(0, (float)(Frame.Size.Height / 5), (float)Frame.Size.Width, (float)(Frame.Size.Height / 2.5f));
            ...
            LettersLabel.Frame = new RectangleF(0,
                (float)NumberLabel.Frame.Y + (float)NumberLabel.Frame.Size.Height + 3,
                (float)Frame.Size.Width, 10);
        ...
        public UILabel StandardLabel()
        {
            ...
            label.TextColor = UIColor.White.FabicColour(Fabic.Data.Enums.FabicColour.Purple); ;
